            ...
            <div className="profile-container">
                <div className="profile-header">
                    ...
                    <div className="header-actions">
                        ...
                        <button className="logout-profile-btn" onClick={handleLogout} style={{ background: '#e74c3c', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer', marginLeft: '10px' }}>
                            Logout
                        </button>
                    </div>
                </div>
